...
class MeshGraph
{
    ...
    int index_vertex(int vertexId) const;
    double filter_function(FilterType type,double alpha,double distance) const;
    void                SortImmediateNeighbours(std::vector<int>& outVertexIds,
                                            int vertexId) const;
